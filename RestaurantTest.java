...
class RestaurantTest {
    ...
    @Test
    public void calculate_order_total_should_return_correct_total_for_selected_items() {
        int total = restaurant.calculateOrderTotal("Sweet corn soup", "Vegetable lasagne");
